...
from olap3.abstract.mdx_result import MDXResult
from olap3.utils import aslist


class TupleFormatReader(MDXResult):
    ...
    def getAxisTuple(self, axis):
        ...
        res = None
        try:
            if isinstance(axis, six.stringtypes):
    ...
    def getSlice(self, properties=None, **kw):
        ...
        while lastdimchange < len(axisranges):
            ...
            if properties is None:
                ...
                if isinstance(properties, six.stringtypes):
